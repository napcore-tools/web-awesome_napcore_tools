...
export default defineConfig({
  ...
  themeConfig: {
    ...
    nav: [
      { text: 'Home', link: '/' },
      { text: 'Browse Tools', link: '/categories/' },
      ...
      '/categories/': [
        {
          ...
          items: [
            ...
            { text: 'Reference Implementations', link: '/categories/reference-implementations/' },
            { text: 'Development Tools', link: '/categories/development-tools/' },
    ...
    footer: {
      ...
      copyright: '© 2025 NAPCORE - National Access Point Coordination Organisation for Europe'
    },
