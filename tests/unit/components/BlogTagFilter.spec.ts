  ...
  data: [
    {
      ...
      date: { time: 1609459200000, string: 'Jan 01, 2021' },
    ...
    },
    {
      ...
      date: { time: 1609545600000, string: 'Jan 02, 2021' },
      tags: ['javascript', 'vue'],
      published: true,
    },
    {
      title: 'Post 3',
      url: '/blog/posts/post-3',
      description: 'Description 3',
      date: { time: 1609632000000, string: 'Jan 03, 2021' },
      tags: ['testing'],
      published: true,
    },
  ],
...
// Mock BlogGrid BEFORE importing
vi.mock('../../../docs/.vitepress/theme/components/blog/BlogGrid.vue', () => ({
  default: {
    name: 'BlogGrid',
    props: ['selectedTags'],
...
import BlogTagFilter from '../../../docs/.vitepress/theme/components/blog/BlogTagFilter.vue';
