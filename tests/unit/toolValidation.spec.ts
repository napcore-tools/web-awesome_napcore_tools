...
import type { Tool } from '../../docs/.vitepress/tools.data';

// Mock the standardValidation module BEFORE importing
vi.mock('../../docs/.vitepress/standardValidation', () => ({
  validateStandards: vi.fn(() => []),
}));

// Mock the validationUtils module BEFORE importing
vi.mock('../../docs/.vitepress/validationUtils', () => ({
  handleValidationResult: vi.fn(),
}));

// Import after mocking
import { validateTool } from '../../docs/.vitepress/toolValidation';
