...
vi.mock('../../../docs/.vitepress/standards', () => ({
  STANDARDS: {
...
vi.mock('../../../docs/.vitepress/blogTags', () => ({
...
import { resolveTag, resolveTags, type ResolvedTag } from '../../../docs/.vitepress/theme/utils/tagResolver';
